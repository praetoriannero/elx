...
// static inline void array_init(Array* self, Allocator* alloc, usize
// datum_size, usize capacity) {
//   self->data = allocator_alloc(alloc, datum_size * capacity);
//   self->length = capacity;
// }
//
// static inline Array* array_new(Allocator* alloc, usize datum_size, usize
// capacity) {
