...
void* new (Allocator* alloc, usize size) { return allocator_alloc(alloc, size); }

void* resize(Allocator* alloc, void* old_ptr, usize new_size) { return allocator_realloc(alloc, old_ptr, new_size); }

void delete (Allocator* alloc, void* ptr) { allocator_free(alloc, ptr); }

void move(Allocator* src, Allocator* dst, void* ptr) { allocator_move(src, dst, ptr); }
